...
export default function RegisterPage() {
  ...
  useEffect(() => {
    if (usernameAutoGenerated && name && !username) {
  ...
  }, [name, usernameAutoGenerated, username, setValue]);
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  />
                  {usernameAutoGenerated && name && username && (
                ...
                <Input
                  ...
                  {...register("password2", {
                    validate: (value) => {
                      ...
                      const error = validatePasswordMatch(currentPassword, value);
                      return error || true;
                    },
                    onChange: async () => {
                      await trigger("password2");
