...
import { validatePasswordMatch } from "@/helpers/auth.helpers";
...
export default function RegisterPage() {
  ...
  useEffect(() => {
    if (usernameAutoGenerated && firstName && lastName && !username) {
      ...
      if (generatedUsername) {
        setValue("username", generatedUsername, { shouldValidate: false });
      }
    }
  }, [firstName, lastName, usernameAutoGenerated, username, setValue]);
