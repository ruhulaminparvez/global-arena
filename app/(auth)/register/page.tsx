...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-accent-950 py-8">
          ...
          >
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <Input
                  label={<span className="text-primary-300 font-medium tracking-wide uppercase text-xs">ফর্মের প্রথম নাম</span>}
                  type="text"
                  icon={User}
                ...
                <Input
                  label={<span className="text-primary-300 font-medium tracking-wide uppercase text-xs">ফর্মের শেষ নাম</span>}
                  type="text"
                  icon={User}
                ...
                <div className="flex items-start gap-2">
                  ...
                  <button
                    ...
                    className="mt-8 h-11 px-3 rounded-lg border border-white/20 bg-white/5 text-primary-300 hover:bg-white/10 hover:border-white/30 hover:text-white disabled:opacity-50 disabled:cursor-not-allowed transition-colors inline-flex items-center gap-1.5 text-sm font-medium shrink-0 backdrop-blur-sm"
                  >
                ...
                <Input
                  label={<span className="text-primary-300 font-medium tracking-wide uppercase text-xs">ফোন নম্বর</span>}
                  type="tel"
                  icon={Phone}
                  placeholder="০১XXXXXXXXX (১০–১১ সংখ্যা)"
                  {...register("phoneOrEmail")}
                  error={errors.phoneOrEmail?.message}
                  className="bg-black/20 border-white/10 text-white placeholder-slate-500 focus:ring-primary-500/50 focus:border-primary-500 backdrop-blur-sm md:col-span-2"
                />

                <Input
                  label={<span className="text-primary-300 font-medium tracking-wide uppercase text-xs">এনআইডি</span>}
                  type="text"
                  icon={CreditCard}
                ...
                <div className="w-full md:col-span-2">
                  <label className="block text-primary-300 font-medium tracking-wide uppercase text-xs mb-2">
                    ছবি <span className="text-red-500">*</span>
                  </label>
                  {photo ? (
                    <div className="relative">
                      <div
                        className={`flex items-center space-x-3 p-3 border-2 rounded-lg transition-colors bg-black/20 backdrop-blur-sm ${errors.photo
                          ? "border-red-500/50"
                          : "border-white/10"
                          }`}
                      >
                    ...
                    <label
                      className={`flex flex-col items-center justify-center w-full h-32 border-2 border-dashed rounded-lg cursor-pointer transition-colors bg-black/20 backdrop-blur-sm ${errors.photo
                    ...
                    >
                      <div className="flex flex-col items-center justify-center pt-5 pb-6">
                        <Upload
                          className={`w-8 h-8 mb-2 ${errors.photo ? "text-red-400" : "text-slate-400"
                            }`}
                        />
                        <p className="mb-2 text-sm text-slate-300">
                          <span className="font-semibold text-white">ক্লিক করুন</span> অথবা ফাইল টেনে আনুন
                        </p>
                        <p className="text-xs text-slate-500">PNG, JPG, JPEG (সর্বোচ্চ ৫ এমবি)</p>
                      </div>
                      <input
                        type="file"
                        className="hidden"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-6 border-t border-white/10">
                ...
                <Input
                  label={<span className="text-primary-300 font-medium tracking-wide uppercase text-xs">নমিনির নাম</span>}
                  type="text"
                  icon={User}
                ...
                <Input
                  label={<span className="text-primary-300 font-medium tracking-wide uppercase text-xs">নমিনির এনআইডি</span>}
                  type="text"
                  icon={CreditCard}
                ...
                <div className="w-full md:col-span-2">
                  ...
                  {nomineePhoto ? (
                    <div className="relative">
                      <div
                        className={`flex items-center space-x-3 p-3 border-2 rounded-lg transition-colors bg-black/20 backdrop-blur-sm ${errors.nomineePhoto
                          ? "border-red-500/50"
                          : "border-white/10"
                          }`}
                      >
                    ...
                    <label
                      className={`flex flex-col items-center justify-center w-full h-32 border-2 border-dashed rounded-lg cursor-pointer transition-colors bg-black/20 backdrop-blur-sm ${errors.nomineePhoto
                        ? "border-red-500/50 hover:bg-white/5"
                        : "border-white/10 hover:border-white/30 hover:bg-white/5"
                        }`}
                    >
                      <div className="flex flex-col items-center justify-center pt-5 pb-6">
                        <Upload
                          className={`w-8 h-8 mb-2 ${errors.nomineePhoto ? "text-red-400" : "text-slate-400"
                            }`}
                        />
                        <p className="mb-2 text-sm text-slate-300">
                          <span className="font-semibold text-white">ক্লিক করুন</span> অথবা ফাইল টেনে আনুন
              ...
              <div className="grid grid-cols-1 gap-6 pt-6 border-t border-white/10">
                ...
                <Input
                  label={<span className="text-primary-300 font-medium tracking-wide uppercase text-xs">রেফারেন্সের নাম</span>}
                  type="text"
                  icon={User}
              ...
              <div className="flex items-start pt-6 border-t border-white/10">
            ...
            <div className="mt-8">
              ...
              <Link href="/login">
                <Button
                  variant="outline"
                  size="lg"
                  className="w-full mt-6 border-white/20 text-slate-300 hover:bg-white/10 hover:text-white backdrop-blur-sm transition-all"
                  type="button"
                >
                  সাইন ইন করুন
                </Button>
